-- LifeOS migration 0066 — repair the live route-decision idempotency clause.
-- The catalog index is partial (idempotency_key IS NOT NULL), so PostgreSQL
-- requires the same predicate in the conflict target.
