...
## Doc Purpose: Every Artifact Defined in this Document Must be Generated.

The primary objective of this document is to serve as a comprehensive and actionable framework for identifying, tracking, and producing vital migration artifacts. Rather than relying on static, hand-drawn diagrams that quickly become obsolete, the goal is to systematically generate version-controlled, diffable artifacts that are directly tied to active, real systems. Delineating these core requirements across codebase, data, infrastructure, and application integrations helps teams eliminate operational unknowns, establish robust testing and validation evidence, and maintain strict cutover and rollback controls to successfully minimize migration risks.
...
## Critical artifacts by migration type

### 1\. **Codebase migration**

Use when moving languages, frameworks, monoliths to services, legacy apps to modern platforms, or repos to new standards.
...
**Especially useful:** A **code map for debugging** that includes:
