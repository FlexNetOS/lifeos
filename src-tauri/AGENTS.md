...
| `icons/` | Full Tauri icon set (32px / 128px / @2x / .icns / .ico / Android mipmaps / iOS). Source: `../public/lifeos-mark.png`. Regenerate via `cargo tauri icon` (run from `../`) when the source changes. |
...
- `../public/lifeos-mark.png` — canonical icon source for `icons/`.
...
```bash
cargo tauri icon public/lifeos-mark.png
