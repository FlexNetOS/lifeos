<script>
  // LifeOS — SettingsView SFC (Svelte port of SettingsView.vue)
  ...
  let resetVaultConfirm = $state(false);
  ...
  let version = $state({ app: "—", tauri: "Web preview", target_triple: "Web preview" });
  ...
  <div class="settings-main">
    ...
    >
      ...
      <dl class="settings-meta" data-test="settings-account-meta">
        <div class="settings-meta-row">
          ...
          <dd class="settings-meta-value" data-test="settings-account-name">{authState.account?.displayName || "—"}</dd>
        </div>
        <div class="settings-meta-row">
          <dt class="settings-meta-key">Email</dt>
          <dd class="settings-meta-value" data-test="settings-account-email">{authState.account?.email || "—"}</dd>
        </div>
      </dl>
      <div class="settings-account-actions">
        ...
        {:else}
          ...
          <button
            ...
            onclick={() => resetVaultConfirm = false}
          >
            Cancel
          </button>
        {/if}
    ...
    >
      ...
      <label class="settings-field">
        ...
        <select
          ...
          value={lifeosState.aiProvider}
          aria-label="Active AI provider"
          onchange={onAiProviderChange}
        >
          {#each lifeosState.availableAiProviders as name (name)}
    ...
    >
      ...
      <label class="settings-toggle-row">
        <input
          ...
          checked={lifeosState.telemetryEnabled}
        ...
        {#each REFRESH_OPTIONS as opt (opt.ms)}
          ...
          >
            <input
              ...
              value={opt.ms}
              checked={lifeosState.telemetryRefreshMs === opt.ms}
              onchange={() => onRefreshRateChange(opt.ms)}
            />
    ...
    >
      ...
      <div class="settings-swatch" aria-label="Active theme">
        <span class="settings-swatch-dot" aria-hidden="true"></span>
