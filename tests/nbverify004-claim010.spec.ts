...
describe("NBVERIFY-004 SWARM-CLAIM-010 evidence", () => {
  test("records the live owner-published swarm status boundary", () => {
    ...
    expect(claim.evidence).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ relationship: "ui-status-runtime", proven: true }),
        expect.objectContaining({ relationship: "canonical-status-flow", proven: true }),
